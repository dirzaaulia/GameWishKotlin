package com.dirzaaulia.gamewish.modules.fragment.home.listener
...
class NavigationIconClickListener @JvmOverloads internal constructor(
    ...
    override fun onClick(view: View) {
        ...
        val translateY = height - context.resources.getDimensionPixelSize(R.dimen.wishlist_reveal_height)
